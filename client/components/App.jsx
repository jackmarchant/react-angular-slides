App = React.createClass({
	...
	getSlideContent() {
		let contentObject = {
			...
			'2': '<div class="col-xs-6"><h2>React</h2><ul><li>Virtual DOM</li><li>One-way data flow</li><li>Is a <strong>library</strong> just for the UI</li><li>If you know JavaScript, you know React</li></ul></div><div class="col-xs-6"><h2>Angular</h2><ul><li>Full-featured MVC framework</li><li>Two-way data-binding</li><li>Extension of HTML</li><li>Gives you a lot for free</li></ul></div>',
			'3': '<div class="col-xs-6"><h2>React</h2><p>React makes no assumptions about the rest of your tech stack and is easily integrated into existing projects.</p></div><div class="col-xs-6"><h2>Angular</h2><p>Angular does a lot of heavy lifting for you, but you have to dive in completely with Angular principles.</p></div>',
			'4': '<h2>In my experience...</h2><p>For those reasons, React was the better choice for me, after having tried to integrate Angular into existing projects.</p><p>It just didn\'t work well, and ended up being very cluttered</p>',
			'5': '<h2>Angular</h2><ul><li><p>I tried to learn Angular before React and the learning curve was much steeper than I had anticipated.</p></li><li><p>Managing the state of the application was difficult, because you\'re managing both a model and view together, which can result in an out of sync UI.</p></li></ul>',
			'6': '<h2>React</h2><ul><li><p>React was much easier to pick up and run with. To make components composed of other smaller components, seemed to make sense to me. </p></li><li><p>JavaScript is fast. The Virtual DOM makes React fast. Consider a list of 100 items, in react and angular, then making a change to one item</p></li><li><p>React: will render only the changes to the DOM, whereas, Angular: will render the 100 items again.</p></li></ul>',
			...
			'8': '<h2>I\'m biased but not really</h2><p>For me, React is the winner, but it\'s almost running a different race to Angular. Comparing a Library to a Framework is like apples to oranges.</p><p>Angular is great and I\'d like to learn more about it, however React has solved a lot of problems for me and it\'s more about the ideas you can take from each, rather than whose syntax or conventions are better.</p>',
			'9': '<h2>Do one thing, and do it well</h2><p>I don\'t know if it\'s possible to have a clear winner, there\'s some things Angular does really well but there are parts where it falls short and React has things like rendering on the server.</p><p>Angular does a lot of things, but React does one thing, the view layer, and it does it really well.</p>',
			'10': '<p>Ideas are better than best practices and syntax.</p><p>Angular and React might not be around in years to come, but their ideas will likely remain in their successors.</p>',
